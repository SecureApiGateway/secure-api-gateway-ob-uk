...
export-config --path /var/tmp/amster --realmEntities 'OAuth2Clients IdentityGatewayAgents SoftwarePublisher Applications RemoteConsentService RemoteConsentAgent ResourceTypes'
:quit
EOF
