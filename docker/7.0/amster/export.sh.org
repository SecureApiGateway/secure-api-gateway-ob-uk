...
export-config --path /var/tmp/amster --realmEntities 'OAuth2Clients IdentityGatewayAgents Applications RemoteConsentService SoftwarePublisher' --globalEntities ' '
:quit
EOF
