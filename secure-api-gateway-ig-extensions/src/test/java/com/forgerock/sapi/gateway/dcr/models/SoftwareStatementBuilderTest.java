...
class SoftwareStatementBuilderTest {
    ...
    private SoftwareStatementBuilder ssBuilder;
    ...
    @BeforeEach
    void setUp() {
        ssBuilder = new SoftwareStatementBuilder(trustedDirectoryService, jwtDecoder);
    }
    ...
    void successJwksUriBased_buildSoftwareStatement()
            throws DCRRegistrationRequestBuilderException, JwtReconstructionException, MalformedURLException {
        // Given
        ...
        SoftwareStatement softwareStatement = ssBuilder.buildSoftwareStatement("txId", SSA_JWT_STRING);

        // Then
        assertThat(softwareStatement).isNotNull();
        assertThat(softwareStatement.getOrg_id()).isEqualTo(ORG_ID);
        assertThat(softwareStatement.getSoftware_id()).isEqualTo(SOFTWARE_ID);
    ...
    void successJwksBased_buildSoftwareStatement() throws DCRRegistrationRequestBuilderException,
            JwtReconstructionException, JwtException {
        // Given
        SignedJwt ssaJwt = mock(SignedJwt.class);
        ...
        assertThat(softwareStatement.getStringClaim(TRUSTED_DIRECTORY_OPEN_BANKING_TEST.getSoftwareStatementOrgIdClaimName())).isEqualTo(ORG_ID);
    }

    @Test
    void failInvalidJwt_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        SignedJwt ssaJwt = mock(SignedJwt.class);
        JwtClaimsSet claimsSet = getValidJwkUriBasedClaims();
        ...
        when(jwtDecoder.getSignedJwt(SSA_JWT_STRING))
                .thenThrow(JwtReconstructionException.class);
        DCRRegistrationRequestBuilderException exception = catchThrowableOfType(()->
                ssBuilder.buildSoftwareStatement("txId", SSA_JWT_STRING),
    ...
    @Test
    void failNoIssuerClaim_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        SignedJwt ssaJwt = mock(SignedJwt.class);
        JwtClaimsSet claimsSet = getValidJwkUriBasedClaims();
        ...
        DCRRegistrationRequestBuilderException exception = catchThrowableOfType(()->
                ssBuilder.buildSoftwareStatement("txId", SSA_JWT_STRING), DCRRegistrationRequestBuilderException.class);
        // Then
        assertThat(exception).isNotNull();
        assertThat(exception.getErrorCode()).isEqualTo(DCRErrorCode.INVALID_SOFTWARE_STATEMENT);
    }
    ...
    @Test
    void failUnrecognisedIssuer_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        SignedJwt ssaJwt = mock(SignedJwt.class);
    ...
    @Test
    void failNoOrgId_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        SignedJwt ssaJwt = mock(SignedJwt.class);
    ...
    @Test
    void failNoSoftwareId_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        ...
        when(trustedDirectoryService.getTrustedDirectoryConfiguration(ISSUER))
                .thenReturn(TRUSTED_DIRECTORY_OPEN_BANKING_TEST);
        DCRRegistrationRequestBuilderException exception = catchThrowableOfType(()->
                ssBuilder.buildSoftwareStatement("txId", jwtString), DCRRegistrationRequestBuilderException.class);
        // Then
        assertThat(exception).isNotNull();
        assertThat(exception.getErrorCode()).isEqualTo(DCRErrorCode.INVALID_SOFTWARE_STATEMENT);
    }
    ...
    @Test
    void failNoJwksUri_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        String jwtString = "header.payload.sig";
        SignedJwt ssaJwt = mock(SignedJwt.class);
    ...
    @Test
    void failNoJwks_buildSoftwareStatement() throws JwtReconstructionException {
        // Given
        String jwtString = "header.payload.sig";
        SignedJwt ssaJwt = mock(SignedJwt.class);
    ...
    private JwtClaimsSet getValidJwkBasedClaims() throws JwtReconstructionException {
        Map<String, Object> claims = Map.of("iss", ISSUER,
