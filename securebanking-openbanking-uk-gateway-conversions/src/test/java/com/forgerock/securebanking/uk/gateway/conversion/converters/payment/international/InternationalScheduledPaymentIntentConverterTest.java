 ...
 */
@TestWithResources
public class InternationalScheduledPaymentIntentConverterTest {

    @GivenTextResource("internationalScheduledPaymentIntent5.json")
    static String internationalScheduledPaymentIntent5;

    @GivenTextResource("internationalScheduledPaymentIntent6.json")
    static String internationalScheduledPaymentIntent6;

    private static Stream<Arguments> validArguments() {
        return Stream.of(
                arguments(
                        new InternationalScheduledPaymentIntentConverter5(),
                        OBWriteInternationalScheduledConsentResponse5.class,
                        internationalScheduledPaymentIntent5,
                        InternationalScheduledPaymentIntentExpectedResponses.getExpectedOBWriteInternationalScheduledConsentResponse5()

                ),
                arguments(
                        new InternationalScheduledPaymentIntentConverter6(),
                        OBWriteInternationalScheduledConsentResponse6.class,
                        internationalScheduledPaymentIntent6,
                        InternationalScheduledPaymentIntentExpectedResponses.getExpectedOBWriteInternationalScheduledConsentResponse6()
