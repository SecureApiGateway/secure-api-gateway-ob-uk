...
/**
 * Unit tests for<br/>
 * {@link DomesticPaymentIntentConverter4}
 * {@link DomesticPaymentIntentConverter5}
 */
@TestWithResources
public class DomesticPaymentIntentConverterTest {
    ...
    private static Stream<Arguments> validArguments() {
        return Stream.of(
                arguments(
                        new DomesticPaymentIntentConverter4(),
                        OBWriteDomesticConsentResponse4.class,
                        domesticPaymentIntent4,
                        DomesticPaymentExpectedResponses.getExpectedOBWriteDomesticConsentResponse4()

                ),
                arguments(
                        new DomesticPaymentIntentConverter5(),
                        OBWriteDomesticConsentResponse5.class,
                        domesticPaymentIntent5,
                        DomesticPaymentExpectedResponses.getExpectedOBWriteDomesticConsentResponse5()
