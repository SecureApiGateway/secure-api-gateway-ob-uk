    ...
    private static Stream<Arguments> validArguments() {
        return Stream.of(
                arguments(
                        ...
                        DomesticStandingOrderExpectedFactory.getExpectedOBWriteDomesticStandingOrderConsentResponse5()
                ),
                arguments(
                        new DomesticStandingOrderIntentConverter6(),
                        OBWriteDomesticScheduledConsentResponse5.class,
                        domesticStandingOrderIntent6,
                        DomesticStandingOrderExpectedFactory.getExpectedOBWriteDomesticStandingOrderConsentResponse6()
