...
/**
 * Unit tests for <br/>
 * {@link DomesticStandingOrderIntentConverter5}
 * {@link DomesticStandingOrderIntentConverter6}
 */
@TestWithResources
public class DomesticStandingOrderPaymentIntentConverterTest {

    @GivenTextResource("domesticStandingOrderIntent5.json")
    static String domesticStandingOrderIntent5;

    @GivenTextResource("domesticStandingOrderIntent6.json")
    static String domesticStandingOrderIntent6;

    private static Stream<Arguments> validArguments() {
        return Stream.of(
                arguments(
                        new DomesticStandingOrderIntentConverter5(),
                        OBWriteDomesticScheduledConsentResponse4.class,
                        domesticStandingOrderIntent5,
                        DomesticStandingOrderExpectedResponses.getExpectedOBWriteDomesticStandingOrderConsentResponse5()
                ),
                arguments(
                        new DomesticStandingOrderIntentConverter6(),
                        OBWriteDomesticScheduledConsentResponse5.class,
                        domesticStandingOrderIntent6,
                        DomesticStandingOrderExpectedResponses.getExpectedOBWriteDomesticStandingOrderConsentResponse6()
